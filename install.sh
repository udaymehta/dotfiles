#!/bin/sh
echo "$(tput setaf 1)Welcome!$(tput setaf 1)" && sleep 5
echo
echo
echo
...
cp -r ./.config/* ~/.config/
cp -r ./bin/* ~/bin
echo "$(tput setaf 2)Copying completed!$(tput setaf 1)" && sleep 5
echo
echo "$(tput setaf 4)Adding ~/.bin to your PATH now$(tput setaf 1)"
echo -e '\nexport PATH="${PATH}:$HOME/bin/"' >> ~/.bashrc
sleep 5
echo
echo
echo
echo "$(tput setaf 2)Woohoo!! INSTALLATION COMPLETED SUCCESSFULLY!!!$(tput setaf 1)"
